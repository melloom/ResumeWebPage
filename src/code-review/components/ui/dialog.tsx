...
// Override the default DialogContent to ensure solid background
const DialogContentSolid = React.forwardRef<
...
DialogContentSolid.displayName = "DialogContentSolid";
